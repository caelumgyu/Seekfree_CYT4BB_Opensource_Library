...
#define DL1A_SCL_PIN                                        (P05_1)             // 软件 IIC SCL 引脚 连接 VL53L0X 的 SCL 引脚
#define DL1A_SDA_PIN                                        (P05_2)             // 软件 IIC SDA 引脚 连接 VL53L0X 的 SDA 引脚
//====================================================软件 IIC 驱动====================================================
#else
#error "暂不支持硬件IIC通讯"
#endif

#define DL1A_XS_PIN                                         (P05_3)
#define DL1A_INT_ENABLE                                     ( 0 )               // 是否启用 INT 引脚 启用则会自动更新数据
#if DL1A_INT_ENABLE
#define DL1A_INT_PIN                                        (P05_4)
#endif
